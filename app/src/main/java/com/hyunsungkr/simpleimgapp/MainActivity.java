...
import com.hyunsungkr.simpleimgapp.adapter.PostAdapter;
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for(int i=0;i<data.length();i++){
                                Post post = new Post(data.getJSONObject(i).getInt("albumId"),data.getJSONObject(i).getInt("id"),
                                        data.getJSONObject(i).getString("title"),data.getJSONObject(i).getString("url"),
